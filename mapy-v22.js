    ...
    function showKuryrNotice(state) {
        ...
        if (state === 'outofrange') {
            ...
            n.innerHTML = [
                ...
                '    <div style="font-size:13px;color:#666;margin-top:2px;">Adresa je dál než 100 km, kam běžně nedoručujeme. Domluva je ale možná individuálně telefonicky na <a href="tel:+420776003155" style="color:' + PRIMARY + ';font-weight:600;white-space:nowrap;">+420 776 003 155</a>. Jinak zvolte osobní odběr nebo zadejte jinou adresu výše.</div>',
                '  </div>',
                '</div>',
            ].join('');
        } else {
