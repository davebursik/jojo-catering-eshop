(function () {
    ...
    function createWidget(container, opts) {
        ...
        function showOk(km, zone) {
            var free = km <= FREE_DELIVERY_MAX_KM && getCartTotal() >= FREE_DELIVERY_THRESHOLD;
            var priceHtml = free
                ? '<strong style="color:#1a7a40;">Doprava zdarma</strong>'
                : 'Cena dopravy: <strong>' + zone.price + ' Kč</strong>';
