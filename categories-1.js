(function () {
    ...
    function init() {
        ...
        var cats = [
            ...
            { label: 'Průvodce',      sub: 'jak objednat',     href: '/blog/pruvodce-objednavkou/', img: null },
        ];
        ...
        style.textContent = [
            ...
            '.jojo-cats{display:grid;grid-template-columns:repeat(6,1fr);gap:10px}',
        ...
        // Vložit za hero sekci, pokud existuje — jinak před první .before-carousel
        var hero = document.getElementById('jojo-hero');
        if (hero) {
            hero.insertAdjacentElement('afterend', wrap);
        } else {
            var anchor = document.querySelector('.before-carousel') || document.querySelector('.content-wrapper');
