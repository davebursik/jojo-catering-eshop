(function () {
    ...
    function init() {
        ...
        style.textContent = [
            '.jojo-hero-wrap{margin:18px 0 22px}',
            ...
            '  .jojo-hero-wrap{margin:10px 0 16px}',
        ...
        // ─── Hero (bez vlastního .container — zdědí ho z carouselu) ────────────
        ...
        // ─── Vložení: dovnitř stejného .container jako carousel ───────────────
        // (zdědí správné odsazení pod mobilní hlavičkou — žádné JS měření)
        var container = document.querySelector('.before-carousel .container');
        if (container) {
            container.insertAdjacentElement('afterbegin', hero);
        } else {
