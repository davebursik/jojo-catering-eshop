(function () {
    ...
    function init() {
        ...
        style.textContent = [
            ...
            '.jojo-hero{display:flex;gap:24px;background:#fff;border:1px solid #efe4eb;border-radius:20px;padding:32px;box-shadow:0 10px 30px rgba(76,21,54,.06);font-family:inherit}',
            ...
            '.jojo-btn{background:#4C1536;color:#fff!important;font-weight:700;border-radius:11px;padding:13px 24px;font-size:15px;text-decoration:none!important;display:inline-flex;align-items:center;gap:8px;cursor:pointer;border:none}',
            '.jojo-btn:hover{background:#6a1e4b;color:#fff!important}',
            ...
            '.jojo-tile{border-radius:13px;background-size:cover;background-position:center;box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}',
