(function () {
  ...
  s.textContent = [
    '#joj-tb{position:fixed;top:0;left:0;right:0;z-index:99999;background:' + PRIMARY + ';color:rgba(255,255,255,.9);padding:5px 20px;display:flex;align-items:center;justify-content:center;gap:0;font-family:var(--template-font),"Source Sans 3",sans-serif;font-size:12px;letter-spacing:.01em;white-space:nowrap;}',
    '#joj-tb-spacer{display:block}',
    ...
    '#jojo-delivery-panel{display:none;position:fixed;left:0;right:0;z-index:99998;background:#fff;padding:22px 0 20px;box-shadow:0 8px 28px rgba(0,0,0,.13);border-bottom:2px solid ' + PRIMARY + ';}',
  ...
  // Spacer + panel.top podle skutečné výšky baru (position:fixed je mimo flow)
